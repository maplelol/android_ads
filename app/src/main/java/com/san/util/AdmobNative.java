...
public class AdmobNative implements View.OnClickListener,View.OnTouchListener{
...
//                        .setTitle("测试" )
//                        .setMessage("AdmobNative onError errorid="+errorCode)
...
//                        .show();
    ...
    public void show() {
        if (this.isLoaded()) {
            ...
            if (mNativeAdContainer == null) {
                mNativeAdContainer = (RelativeLayout)inflater.inflate(R.layout.admob_native_ad_view, null, false);
            ...
            UnifiedNativeAdView adView = (UnifiedNativeAdView)inflater.inflate(R.layout.admob_native_ad, null);
            ...
            FrameLayout frameLayout = this.mNativeAdContainer.findViewById(R.id.admob_native_ad_placeholder);
    ...
    public void export_setOnStatusUpdate() {
        System.out.println("AdmobNative export_setOnStatusUpdate");
    }

    public void export_isLoaded() {
        System.out.println("AdmobNative export_isLoaded");
        AdsUtil.callbackToJS(this,"export_isLoaded", this.isLoaded());
    }

    public void export_load() {
        System.out.println("AdmobNative export_load");
        final AdmobNative mThis = this;
    ...
    public void export_show() {
        System.out.println("AdmobNative export_show");
        final AdmobNative mThis = this;
        AdsUtil.getActivity().runOnUiThread(new Runnable() {
            @Override
            public void run() {
    ...
    public void import_onStatusUpdate(String szResult) {
        System.out.println("AdmobNative import_onStatusUpdate");
