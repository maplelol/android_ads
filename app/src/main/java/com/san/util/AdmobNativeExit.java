...
public class AdmobNativeExit implements View.OnClickListener,View.OnTouchListener{
    private static final String GOOGLE_UNIT_ID = "ca-app-pub-3940256099942544/2247696110";
    ...
    public AdmobNativeExit(final String strUnitID) {
    ...
    public void load() {
        ...
        final AdmobNativeExit mThis = this;
...
//                        .setTitle("测试" )
//                        .setMessage("AdmobNativeExit onError errorid="+errorCode)
...
//                        .show();
    ...
    public void show() {
        if (this.isLoaded()) {
            ...
            if (mNativeAdContainer == null) {
                mNativeAdContainer = (RelativeLayout)inflater.inflate(R.layout.admob_native_exit_ad_view, null, false);
                ViewGroup.LayoutParams lp = new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
                AdsUtil.getActivity().addContentView(mNativeAdContainer,lp);
                mNativeAdContainer.findViewById(R.id.btn_admob_native_exit_confirm).setOnClickListener(this);
                mNativeAdContainer.findViewById(R.id.btn_admob_native_exit_cancel).setOnClickListener(this);
                mNativeAdContainer.setOnTouchListener(this);
            } else {
                mNativeAdContainer.setVisibility(View.VISIBLE);
            }

            UnifiedNativeAdView adView = (UnifiedNativeAdView)inflater.inflate(R.layout.admob_native_exit_ad, null);
            ...
            System.out.println("this.mAd.getHeadline()="+this.mAd.getHeadline());
            System.out.println("this.mAd.getBody()="+this.mAd.getBody());
            System.out.println("this.mAd.getCallToAction()="+this.mAd.getCallToAction());
            ...
            if (this.mAd.getPrice() == null) {
                ...
                System.out.println("this.mAd.getPrice()="+this.mAd.getPrice());
            }
            ...
            if (this.mAd.getStore() == null) {
                ...
                System.out.println("this.mAd.getStore()="+this.mAd.getStore());
            }
            ...
            if (this.mAd.getAdvertiser() == null) {
                ...
                System.out.println("this.mAd.getAdvertiser()="+this.mAd.getAdvertiser());
            }

            adView.setNativeAd(this.mAd);

            FrameLayout frameLayout = this.mNativeAdContainer.findViewById(R.id.admob_native_exit_ad_placeholder);
    ...
    public void export_setOnStatusUpdate() {
        System.out.println("AdmobNativeExit export_setOnStatusUpdate");
    }

    public void export_isLoaded() {
        System.out.println("AdmobNativeExit export_isLoaded");
        AdsUtil.callbackToJS(this,"export_isLoaded", this.isLoaded());
    }

    public void export_load() {
        System.out.println("AdmobNativeExit export_load");
        final AdmobNativeExit mThis = this;
    ...
    public void export_show() {
        System.out.println("AdmobNativeExit export_show");
        final AdmobNativeExit mThis = this;
        AdsUtil.getActivity().runOnUiThread(new Runnable() {
            @Override
            public void run() {
    ...
    public void import_onStatusUpdate(String szResult) {
        System.out.println("AdmobNativeExit import_onStatusUpdate");
        AdsUtil.callbackToJS(this,"export_setOnStatusUpdate", szResult);
    }

    @Override
    public void onClick(View v) {
        if (v.getId() == R.id.btn_admob_native_exit_confirm) {
            this.onStatusUpdate("confirm");
            this.onStatusUpdate("closed");
        } else if (v.getId() == R.id.btn_admob_native_exit_cancel) {
            this.mAd = null;
